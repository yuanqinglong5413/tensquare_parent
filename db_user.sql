...
insert  into `tb_user`(`id`,`loginname`,`password`,`nickname`,`sex`,`birthday`,`avatar`,`mobile`,`email`,`regdate`,`updatedate`,`lastdate`,`online`,`interest`,`personality`,`fanscount`,`followcount`) values ('1','testuser','111111','小白','男','2018-01-08 15:39:19',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,0);
